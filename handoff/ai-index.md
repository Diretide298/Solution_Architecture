...
| | Holds | Enforced by |
|---|---|---|
| **The vector store is reached by one contract** — 1 collection, 8 operations, all in `ai`. No screen, service or other contract reaches it directly. | yes | tools/check-package.py — no non-AI contract writes an AI table |
...
| **Every model call leaves an audit record** — 6 operations write an `ai.interaction` (8.3.55). | yes | tools/check-package.py — a model-calling operation with no interaction fails |
...
**Storage tiers** — `postgres` 22 · `postgres-analytical` 3 · `qdrant` 1 · `redis` 3
...
`ai.chunk_ref` · `ai.index_entry` · `ai.index_job` · `ai.index_source` · `ai.knowledge_collection` · `ai.knowledge_document` · `ai.layout_draft` · `ai.policy` · `ai.proposed_action` · `ai.provider` · `assets.media_asset` · `catalogue.entitlement_template` · `catalogue.product` · `fnb.menu_item` · `maintenance.inspection_template` · `marketing.case` · `marketing.conversation_message` · `reporting.report_definition` · `retail.merchandise` · `whitelabel.content_page` · `whitelabel.faq_entry` · `whitelabel.policy`
...
19 closed — CF-109 · CF-107 · CF-106 · CF-105 · CF-14 · CF-96 · CF-94 · CF-92 · CF-93 · CF-90 · CF-89 · CF-88 · CF-59 · CF-80 · CF-78 · CF-76 · CF-73 · CF-20 · CF-43
