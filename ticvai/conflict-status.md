...
| **CF-136** | Device management is 60 requirements with no contract, and `tenancy` already covers about half of it — the other half includes an unauthenticated devi | Chinmay |
