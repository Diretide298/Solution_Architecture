...
| | |
|---|---|
| GPU | (hypothetical 22 GiB card) |
| VRAM | 22.4 GiB total, 22.4 GiB free |
| System RAM | 31.6 GiB |
| Disk free | 282 GiB |
...
|---|---|---|---|---|---|
| `qwen3-8b` | **RUNS** | 16.0 GB | 4096 | apache-2.0 | needs ~20.0 GiB of 22.4 GiB free |
| `gte-qwen2-7b` | **RUNS** | 15.2 GB | 3584 | apache-2.0 | needs ~19.0 GiB of 22.4 GiB free |
| `qwen3-4b` | **RUNS** | 8.0 GB | 2560 | apache-2.0 | needs ~10.0 GiB of 22.4 GiB free |
| `qwen3-0.6b` | **RUNS** | 1.2 GB | 1024 | apache-2.0 | needs ~1.5 GiB of 22.4 GiB free |
| `bge-m3` | **RUNS** | 1.1 GB | 1024 | mit | needs ~1.4 GiB of 22.4 GiB free |
| `e5-large` | **RUNS** | 1.1 GB | 1024 | mit | needs ~1.4 GiB of 22.4 GiB free |
| `nomic-v1.5` | **RUNS** | 0.3 GB | 768 | apache-2.0 | needs ~0.4 GiB of 22.4 GiB free |
...
**Runs here now (7):** `qwen3-8b`, `gte-qwen2-7b`, `qwen3-4b`, `qwen3-0.6b`, `bge-m3`, `e5-large`, `nomic-v1.5`

**Would run on a bigger card (0):** none
...
python run_eval.py --models qwen3-8b gte-qwen2-7b qwen3-4b qwen3-0.6b
```
