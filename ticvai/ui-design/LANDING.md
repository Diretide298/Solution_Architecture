# Handoff: Adam landing page

The entry page for Adam. Five nodes in 3D space — one per layer of the delivery package — that you
...
Design file: `designs/Adam Landing.dc.html`. **Design reference, not production code** — recreate it
...
- **Hero, top-left, 430px column.** Adam night lockup at 42px, then `Five layers, one reference
