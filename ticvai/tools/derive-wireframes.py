...
<div class="wrap">
  ...
  <div class="bottom">
    ...
    <span>{len(cards)} boards</span>
        ...
        #
        # Three categories now, and a consumer can act on each: `generated` is ours to rewrite,
        # `clientPacks` is drawn and must never be touched, `unrecognised` is a file this package
        # cannot account for.
