...
010-<schema>.sql       one file per schema, 627 tables
...
re-created those 627 tables and **633 foreign keys went with them.**
...
**`enforced: no` becomes an index and a comment, never a constraint.** 157 of the 1354 relationships
