...
010-<schema>.sql       one file per schema, 388 tables
...
re-created those 388 tables and **569 foreign keys went with them.**
...
**`enforced: no` becomes an index and a comment, never a constraint.** 157 of the 978 relationships
