...
010-<schema>.sql       one file per schema, 556 tables
...
re-created those 556 tables and **571 foreign keys went with them.**
...
**`enforced: no` becomes an index and a comment, never a constraint.** 157 of the 1189 relationships
