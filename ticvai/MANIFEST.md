...
```
1974 operations · 32 contracts · 637 tables · 1346 relationships
...
backend/        DDL, generated — 637 tables, 613 foreign keys, 769 indexes
...
**`handoff/schema-reference.json`** — 637 tables, every column, every reference, and a description
for all of them.
