...
```
1974 operations · 32 contracts · 635 tables · 1357 relationships
...
backend/        DDL, generated — 635 tables, 598 foreign keys, 631 indexes
...
**`handoff/schema-reference.json`** — 635 tables, every column, every reference, and a description
for all of them.
