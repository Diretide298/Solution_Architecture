...
**Amends:** [ADR-0028](0028-service-decomposition.md) — the tenant template is 25 schemas, not 26
...
**The tenant template is 25 schemas.** `control` comes out of it. Nothing else moves: the other 25
are exactly what ADR-0028 decomposed, and no service gains or loses a schema.
