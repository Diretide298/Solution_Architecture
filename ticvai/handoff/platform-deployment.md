...
**15 platforms · 1091 screens · 133 drawn.**

| | Short | Purpose | Audience | Form factor | App | Offline | Screens | Drawn |
|---|---|---|---|---|---|---|---:|---:|
| P01 | **Guest Web** | Guest Web — Storefront | guest | web | `guest-web` | no | 46 | 3 |
| P02 | **Guest App** | Guest App — Mobile | guest | mobileApp | `guest-app` | yes | 71 | 3 |
| P04 | **Venue POS** | Venue POS — Terminal and Tablet | staff | posTerminal | `venue-pos` | yes | 24 | 15 |
| P05 | **Guest Kiosk** | Guest Kiosk — Self-Service | guest | kiosk | `guest-app` | no | 17 | 17 |
| P06 | **Venue Staff App** | Venue Staff App — Operations | staff | mobileApp | `venue-staff-app` | yes | 66 | 21 |
| P07 | **Venue Scanner** | Venue Scanner — Access Control | staff | handheld | `venue-scanner` | yes | 11 | 0 |
| P08 | **Venue Management** | Venue Management — Back Office | staff | web | `venue-management-web` | no | 363 | 60 |
| P09 | **TICVAI Web** | TICVAI Web — Platform Console | platformAdmin | web | `ticvai-web` | no | 318 | 2 |
| P10 | **Partner Web** | Partner Web — Reseller Portal | partner | web | `partner-web` | no | 51 | 2 |
| P11 | **Accreditation Web** | Accreditation Web — Applications | public | web | `accreditation-web` | no | 8 | 0 |
| P12 | **Venue Support** | Venue Support — Agent Console | staff | web | `venue-support-web` | no | 28 | 1 |
| P13 | **Venue CMS** | Venue CMS — White Label | staff | web | `venue-management-web` | no | 60 | 1 |
| P14 | **Developer** | Developer Portal | partner | web | `developer-portal-web` | no | 8 | 0 |
| P15 | **Kitchen Display** | Kitchen Display — Pass and Stations | staff | kiosk | `kitchen-display` | yes | 10 | 7 |
| P16 | **Venue Analytics** | Venue Analytics — Cross-Domain Reporti | staff | web | `venue-management-web` | no | 10 | 1 |
