...
**1628 operations · 388 tables · 1235 screens · 125 state models · 29 events · 96 flows · 44 ADRs**
...
| **`wireframes/TICVAI Wireframe Boards.dc.html`** | 21 boards, 1235 screens. Open in a browser |
...
| | |
|---|---|
| `contracts/` | **1628 operations** across 25 files — 267 spine, 470 satellite |
...
| `wireframes/` | 21 boards from Claude Code, linked to every definition |
...
A design package. **1628 operations, 388 tables and 1235 screens are specified and none of it
has been executed** — no SQL is written, no code is built, and every number above is an
assertion until something runs.

The fastest way to test that is `venue-scanner`: 1235 screens, fully specified, offline-mandatory,
