...
**1626 operations · 28 contracts · 386 tables · 1091 screens · 124 state models · 94 flows · 41 ADRs**
...
| Operations reaching a screen | 1379 of 1626 | 85% |
| Screens reachable from an entry point | 1088 of 1091 | 100% |
| Screens drawn on a board | 1091 of 1091 | 100% |
| Screens in a journey | 262 of 1091 | 24% |
| Conflicts | 149 closed | 14 open, none blocking |
| **Tables written** | **0** of 386 | **build has not started** |
...
| `P08` | Venue Management — Back Office | staff | 363 |
| `P09` | TICVAI Web — Platform Console | platformAdmin | 318 |
...
**Build is 0%.** 386 tables are designed and none is written. No migration has run, no service is scaffolded, and nothing has executed. **The design is 95% of in-scope requirements and the gap to build is the entire remaining risk.**

**94 journeys of a target 60.** Seventeen contracts have exactly one — `subscription` has one over 1626 operations. **Every journey written so far has found a defect**, which is the argument for writing more.

**1091 screens cannot be reached** from their platform's entry point, and navigation is still inferred rather than designed on most of the estate.

**14 conflicts are open.** None blocks build; four need an email and one needs a workshop.
...
*Generated by `tools/derive-overview.py` from the package itself. **Do not hand-edit** — a landing page with typed numbers is a landing page that is wrong within a day, and this one claimed twelve platforms and 92 conflicts on a package that had fifteen and 163.*
