...
[
 ...
 },
 {
  ...
  "states": {
   ...
   "emptyNoAccess": "Names the missing permission. **Never an empty table** — that reads as *there is no data* and sends somebody to support with the wrong question.",
   "offline": "**Nothing here works offline and it says so.** An erasure request queued on a phone and never sent is worse than one that could not be made — the legal clock starts when the platform receives it, not when the guest taps."
  },
  "apis": [
   {
