...
**2,068 operations across 32 contracts** — 796 in the spine, 1,272 in satellites.
...
## Spine — 9 contract(s), 796 operation(s)
...
| GET | `/deposits/{depositId}/activity` | `listDepositActivity` | `PAYMENT_VIEW` | — | — |
| POST | `/deposits/{depositId}/activity` | `recordDepositActivity` | `PAYMENT_CONFIGURE` | — | — |
| GET | `/dunning-cases` | `listDunningCases` | `PAYMENT_CONFIGURE` | — | — |
| POST | `/dunning-cases/{caseId}/resolve` | `resolveDunningCase` | `PAYMENT_CONFIGURE` | — | — |
| GET | `/dunning-policy` | `getDunningPolicy` | `PAYMENT_CONFIGURE` | — | — |
| PUT | `/dunning-policy` | `setDunningPolicy` | `PAYMENT_CONFIGURE` | — | — |
...
| GET | `/payments/rules` | `getPaymentRules` | `PAYMENT_VIEW` | — | — |
| PUT | `/payments/rules` | `setPaymentRules` | `PAYMENT_CONFIGURE` | — | — |
