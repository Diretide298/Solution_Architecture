...
**Then regenerate** `pattern-data.js` and the derived frame inventory. Regenerated 8 September against the patched source: **BP-001 is 337** — 315 measured before the
fold, plus the twenty. The earlier 331 was 314 + the seventeen-screen hand count, and both figures
were short. Pattern count stays 43. If a third number moves, one of the edits did not land.
