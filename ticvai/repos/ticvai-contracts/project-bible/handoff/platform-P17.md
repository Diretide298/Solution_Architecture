# P17 TICVAI Sign-up — platform

**Derived.** `python3 tools/derive-platform.py P17`. App `signup-web` · public · web
...
|---|---|---|
| Onboarding & Assessment | 10 | 3 |
| Package Builder | 7 | 3 |
| Purchase & Activation | 7 | 3 |
...
| `SGN-009` | Integration, Payment & Technical Readiness | Onboarding & Assessment | 3 | 1 | yes |
| `SGN-010` | AI Assessment Summary & Handoff | Onboarding & Assessment | 3 | 1 | yes |
| `SGN-011` | Recommended Package Overview | Package Builder | 3 | 1 | yes |
| `SGN-012` | Commercial Model & Tier Selection | Package Builder | 3 | 2 | yes |
...
| `SGN-022` | Order & Commercial Pricing Review | Purchase & Activation | 3 | 1 | yes |
| `SGN-023` | Commercial Agreement, Billable Definition & Customer Acceptance | Purchase & Activation | 3 | 1 | yes |
| `SGN-024` | Subscription Confirmation & Commercial Activation | Purchase & Activation | 3 | 1 | yes |
