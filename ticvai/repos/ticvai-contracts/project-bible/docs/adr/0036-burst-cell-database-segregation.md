...
**Date:** 31 August 2026
**Related:** ADR-0032's pooling is amended by ADR-0038, which also supersedes this ADR ·
[ADR-0005](0005-venue-isolation-by-partitioning-not-separate-databases.md) · [ADR-0028](0028-service-decomposition.md) · [ADR-0031](0031-contention-and-locking.md) · [ADR-0032](0032-load-shedding-and-pooling.md) · [ADR-0035](0035-burst-environments.md) · **CF-161**
...
**Single tenant. Single event. Destroyed after reconciliation** (ADR-0035, amended 3 September on
`synchronous_commit` — the lifecycle relied on here is unchanged). There is no *"two years
