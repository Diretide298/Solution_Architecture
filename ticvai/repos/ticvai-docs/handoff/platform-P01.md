...
| `WEB-006` | Date & Session Selection | Booking & Selection | 1 | 3 | yes |
...
| `WEB-020` | Profile & Preferences | Account & Self-Service | 1 | 6 | yes |
...
| `WEB-036` | F&B – Browse & Order | In-venue Services | 2 | 10 | yes |
