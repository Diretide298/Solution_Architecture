 ...
 * harness. It shipped a lockup labelled **"Atlas — open the viewer"** that did
...
check('the lockup does not claim to open the viewer',
  (await page.evaluate(() => document.querySelector('.home-lockup')?.getAttribute('aria-label') ?? '')) === 'Atlas');
